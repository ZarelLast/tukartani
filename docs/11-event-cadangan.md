...
*"Kembangkan ide dasar ini menjadi berita yang dramatis, imersif, dan hidup. Tambahkan nama tokoh fiksi, lokasi fiksi di Mukti, atau kutipan wawancara, tapi pertahankan esensi efek makroekonominya."*
...
export const EVENT_CADANGAN_LIST: Berita[] = [
  ...
  { kategori: "kebijakan_moneter", headline: "Pemerintah cetak uang untuk proyek raksasa", penjelasan: "Uang beredar berlebih memicu inflasi, Selga melemah terhadap Dolar.", efek: { kurs: 2 } },
  { kategori: "kebijakan_moneter", headline: "Cadangan Gold Coins Mukti menembus rekor", penjelasan: "Kepercayaan investor tinggi, mata uang lokal Selga menguat tajam.", efek: { kurs: -3 } },
  ...
  { kategori: "kebijakan_moneter", headline: "Pembebasan pajak asing disahkan parlemen", penjelasan: "Aliran modal asing membanjiri Mukti, kurs Selga melonjak.", efek: { kurs: -3 } },
  { kategori: "kebijakan_moneter", headline: "Utang luar negeri Mukti gagal bayar", penjelasan: "Rating kredit turun drastis, kepanikan membuat Selga runtuh.", efek: { kurs: 3 } },
  ...
  { kategori: "krisis_global", headline: "Krisis utang melanda Kerajaan Seberang", penjelasan: "Investor panik cari Dolar; mata uang kecil seperti Selga tertekan.", efek: { kurs: 2 } },
  ...
  { kategori: "krisis_global", headline: "Serangan siber lumpuhkan bank global", penjelasan: "Kepanikan pasar keuangan dunia memicu devaluasi massal di Mukti.", efek: { kurs: 3 } },
  ...
  { kategori: "krisis_global", headline: "Harga minyak dunia meroket tajam", penjelasan: "Negara importir minyak seperti Mukti kehabisan devisa, Selga anjlok.", efek: { kurs: 3 } },
  ...
  { kategori: "permintaan_ekspor", headline: "Kopi Mukti masuk menu resmi maskapai global", penjelasan: "Prestige naik, pembeli berani tawar dengan harga tinggi.", efek: { hargaEksporModifier: 1.25 } },
  ...
  { kategori: "permintaan_ekspor", headline: "Aktor legendaris tertangkap kamera minum kopi Mukti", penjelasan: "Viral di sosial media memicu euforia pembelian instan di luar negeri.", efek: { hargaEksporModifier: 1.3 } },
  { kategori: "permintaan_ekspor", headline: "Regulasi Eropa larang kopi non-organik", penjelasan: "Sertifikasi ditangguhkan, sementara waktu akses pasar tertutup.", efek: { hargaEksporModifier: 0.8 } },
  ...
  { kategori: "harga_komoditas", headline: "Badai es hancurkan kebun kopi Brasilia", penjelasan: "Kelangkaan ekstrem di pasar global memicu lonjakan harga.", efek: { hargaEksporModifier: 1.3 } },
  ...
  { kategori: "harga_komoditas", headline: "Bursa komoditas Mukti catat rekor", penjelasan: "Spekulan masuk memborong kontrak kopi, harga terdongkrak.", efek: { hargaEksporModifier: 1.25 } },
  ...
  { kategori: "harga_komoditas", headline: "Bursa berjangka komoditas kopi baru dibuka", penjelasan: "Likuiditas meningkat memicu tren tren *bullish* untuk harga patokan.", efek: { hargaEksporModifier: 1.1 } },
  ...
  { kategori: "bencana_panen", headline: "Hama penggerek serang kebun Senandu", penjelasan: "Sebagian biji kopimu rusak membusuk sebelum sempat dipetik.", efek: { stokKopiDelta: -25 } },
  ...
  { kategori: "kondisi_lokal", headline: "Pemilihan Kepala Desa Senandu memanas", penjelasan: "Warga sibuk kampanye, namun aktivitas kebun tetap berjalan normal.", efek: {} },
  ...
  { kategori: "kondisi_lokal", headline: "Koperasi Mukti buka layanan konsultasi", penjelasan: "Bantuan teknis kini tersedia; tak memengaruhi kas secara langsung.", efek: {} },
  ...
  { kategori: "kondisi_lokal", headline: "Tim sepak bola Senandu juarai liga antar-desa", penjelasan: "Euforia kemenangan menyelimuti desa selama beberapa hari.", efek: {} },
  ...
  { kategori: "kondisi_lokal", headline: "Kunjungan mendadak bupati ke kebun percontohan", penjelasan: "Aparat sibuk berbenah, warga hanya menonton dari jauh.", efek: {} },
  ...
  { kategori: "kondisi_lokal", headline: "Konser dangdut keliling singgah di Senandu", penjelasan: "Hiburan semalam suntuk membuat buruh tani sedikit begadang.", efek: {} },
  ...
  { penjalasan: "Sebuah komunitas mulai menanam pohon rindang demi estetika desa.", kategori: "kondisi_lokal", headline: "Pemuda desa galakkan aksi penghijauan", efek: {} },
